...
const getSearchProperties = async (req,res) => {
    ...
    const {title} = req.query
        ...
        const posts = await Property.find(query)
...
const createProperty = async (req,res) => {
    ...
    try {
        ...
        const { title, description, propertyType, location, price , photo , email, bathroom , beds, room_size,facilities} = req.body;
        ...
        res.status(601).json({message: error.message})
    }
